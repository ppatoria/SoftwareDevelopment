...
{
	/// <summary>
	/// Summary description for DataBinding_StoringDatasetsViewstate.
	/// </summary>
	public class DataBinding_StoringDatasetsViewstate : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			if(this.IsPostBack)
			{
				System.IO.StringReader sr = new System.IO.StringReader((string)(ViewState["dsCategories"]));
